...
import { ChevronLeft, Search, Package, Plus, Edit3 } from 'lucide-react';
    ...
    <div className="w-full min-h-screen pb-28">
      <div className="px-6 pt-8 pb-4 flex items-center justify-between sticky top-0 bg-slate-50/80 dark:bg-slate-950/80 backdrop-blur-xl z-40">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-black text-slate-900 dark:text-white tracking-tight">Mahsulotlar</h1>
        </div>
