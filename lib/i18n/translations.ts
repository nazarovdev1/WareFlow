...
export const translations = {
  uz: {
    ...
    products: {
      ...
      barcodePrintDesc: 'Mahsulotlar uchun maxsus yorliqlarni loyihalash va chiqarish',
      selectProducts: 'Mahsulotlarni tanlash',
      labelSettings: 'Stiker sozlamalari',
      labelWidth: 'Kengligi',
      labelHeight: 'Balandligi',
    },
    warehouse: {
      title: 'Ombor',
  ...
  ru: {
    ...
    products: {
      ...
      barcodePrintDesc: 'Создание и печать этикеток для товаров',
      selectProducts: 'Выбор товаров',
      labelSettings: 'Настройки этикеток',
      labelWidth: 'Ширина',
      labelHeight: 'Высота',
    },
    warehouse: {
  ...
  en: {
    ...
    products: {
      ...
      barcodePrintDesc: 'Design and print custom labels for products',
